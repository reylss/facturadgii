...
{
    public abstract class ApiCfWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ApiCfWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ApiCfWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ApiCfDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ApiCfDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ApiCfDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ApiCfDbContext, Task<T>> func)
        {
            T result;
