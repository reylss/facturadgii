...
{
    [DbContext(typeof(ApiCfDbContext))]
    partial class ApiCfDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiCf.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("ApiCf.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(19)")
            ...
            modelBuilder.Entity("ApiCf.Entidades.ApiCfAutoNs.ApiCfAuto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
                    ...
                    b.Property<int>("Idecot")
                        .HasColumnType("NUMBER(10)")
                        .HasColumnName("Idecot");

                    b.Property<int>("Idepol")
                        .HasColumnType("NUMBER(10)")
                        .HasColumnName("Idepol");
                    ...
                    b.Property<int>("Numcert")
                        .HasColumnType("NUMBER(10)")
                        .HasColumnName("Numcert");
                    ...
                    b.Property<decimal>("ValorObjeto")
                        .HasColumnType("DECIMAL(18, 2)")
                        .HasColumnName("Valor_Objeto");

                    b.HasKey("Id");

                    b.ToTable("INSPECCION_AUTO");
                });

            modelBuilder.Entity("ApiCf.Entidades.ApiCfAutoNs.ApiCfAutoEvaluacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
                    ...
                    b.Property<string>("Estado")
                        .HasColumnType("NVARCHAR2(2000)")
                        .HasColumnName("StsClasificacion");
                    ...
                    b.HasIndex("ApiCfAutoId");

                    b.ToTable("INSPECCION_AUTO_EVALUACION");
                });

            modelBuilder.Entity("ApiCf.Entidades.ApiCfAutoNs.ApiCfAutoImagen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
                    ...
                    b.Property<string>("ZonaObjetoEvaluar")
                        .HasColumnType("NVARCHAR2(2000)")
                        .HasColumnName("Zona_Objeto_Evaluar");

                    b.HasKey("Id");

                    b.HasIndex("ApiCfAutoId");

                    b.ToTable("INSPECCION_AUTO_IMAGEN");
                });

            modelBuilder.Entity("ApiCf.Entidades.ListaValorNs.ListaValor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("ApiCf.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ApiCf.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ApiCf.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ApiCf.Authorization.Roles.Role", b =>
                {
                    b.HasOne("ApiCf.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("ApiCf.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("ApiCf.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiCf.Entidades.ApiCfAutoNs.ApiCfAutoEvaluacion", b =>
                {
                    b.HasOne("ApiCf.Entidades.ApiCfAutoNs.ApiCfAuto", "ApiCfAuto")
                        .WithMany()
                        .HasForeignKey("ApiCfAutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApiCfAuto");
                });
